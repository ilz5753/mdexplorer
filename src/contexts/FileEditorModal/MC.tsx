import { MDPreview, type IMDPreview } from "@ilz5753/rnmd";
import { isAndroid, left, overlay1, top, gap as uGap } from "@ilz5753/rnutils";
...
export function MDEditorCopyRender({
  colors,
  horizontal = false,
  topSavHeight = 48,
  bottomSavHeight = 34,
    ...
    <KeyboardAvoidingView
      ...
      <Animated.View {...{ style: [styles.f1, BG] }}>
        ...
        <Animated.View {...{ style: [styles.f1] }}>
          {horizontal ? (
            <Animated.View {...{ style: [styles.f1, fd, uGap(pad)] }}>
              <Animated.View
                {...{
            ...
            <Animated.View {...{ style: [styles.f1, uGap(pad)] }}>
              <Animated.View
                {...{
...
export function MDEditorCopy(props: IMDEditor) {
  return (
    <ErrorBoundary>
      <MDEditorCopyRender {...props} />
    </ErrorBoundary>
  );
}
